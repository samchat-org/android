 ...
 */
public abstract class P2PBaseMessageActivity extends UI {
    ...
    private P2PMessageFragment messageFragment;

    protected abstract P2PMessageFragment fragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        messageFragment = (P2PMessageFragment) switchContent(fragment());
    }
        ...
        for (final SessionCustomization.OptionsButton button : buttons) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    button.onClick(P2PBaseMessageActivity.this, v, sessionId);
                }
            });
