...
public class SideBar extends View {
	...
	// 触摸事件  
    private OnSideBarTouchingLetterChangedListener onTouchingLetterChangedListener;
    // 26个字母  
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {  
        ...
        final OnSideBarTouchingLetterChangedListener listener = onTouchingLetterChangedListener;
    ...
    public void setOnTouchingLetterChangedListener(
            OnSideBarTouchingLetterChangedListener onTouchingLetterChangedListener) {
     ...
     *  
     */  
    public interface OnSideBarTouchingLetterChangedListener {
